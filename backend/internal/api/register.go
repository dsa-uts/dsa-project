...
func Register(e *echo.Echo, authStore *store.AuthStore, projectStore *store.ProjectStore, source *resourceimport.Source) {
	...
	generated.RegisterHandlers(g, generated.NewStrictHandler(newHandler(authStore, projectStore, source), nil))
}
